...
public class HUD extends Obj {
    ...
    private String creditText = "ByOyunmer(C)";
    private String startText = "SPACE TO START";
    ...
    public void draw(Graphics2D g) {
        ...
        if (titleState) {
            ...
            g.drawString(creditText, creditX, game.getHeight() - 100);
            g.drawString("A Replica of Asteroids(1979)", creditX - 80, game.getHeight() - 50);
        }
